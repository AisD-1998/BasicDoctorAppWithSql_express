...
public class Medecin_adapter extends BaseAdapter {
    ...
    public static class ViewHolder {
        ...
        ImageView valImage; // Add ImageView for the image
    }
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            holder.valImage = convertView.findViewById(R.id.valImage); // Initialize ImageView
        ...
        try {
            ...
            // Set image from the path to the ImageView
            String imagePath = List_Medecin.get(position).get("valImage").toString();
            Glide.with(context)
                    .load(imagePath)
                    .placeholder(R.drawable.placeholder_image) // Optional: placeholder image
                    .error(R.drawable.error_image) // Optional: error image
                    .into(holder.valImage);
            return convertView;
