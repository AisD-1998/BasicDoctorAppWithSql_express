...
public class Medecin {
    ...
    private  String Nom_Medecin,Prenom_Medecin,Specialite_Medecin,Ville_Medecin,Description_Medecin, Image_path;
    ;
    public Medecin(){}
    public Medecin(String nom_Medecin, String prenom_Medecin, String specialite_Medecin, String ville_Medecin, String description_Medecin,String image_path ) {
    ...
    public Medecin(int code_Medecin, String nom_Medecin, String prenom_Medecin, String specialite_Medecin, String ville_Medecin, String description_Medecin,String image_path) {
